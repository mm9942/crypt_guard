...
impl<KyberSize, ContentStatus> KyberFunctions
    for Kyber<Encryption, KyberSize, ContentStatus, XChaCha20Poly1305>
where
    KyberSize: KyberSizeVariant,
{
    ...
    fn encrypt_file(
        ...
        let mut xchacha = CipherChaChaPoly::new(infos, None);
...
impl<KyberSize, ContentStatus> KyberFunctions
    for Kyber<Decryption, KyberSize, ContentStatus, XChaCha20Poly1305>
where
    KyberSize: KyberSizeVariant,
{
