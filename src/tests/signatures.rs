...
#[test]
fn test_falcon1024_signature_message() {
...
#[test]
fn test_falcon1024_detached_signature() {
    let (public_key, secret_key) = Falcon1024::keypair();
    let data = b"Hello, world!".to_vec();
...
#[test]
fn test_falcon512_signature_message() {
...
#[test]
fn test_falcon512_detached_signature() {
    let (public_key, secret_key) = Falcon512::keypair();
    let data = b"Hello, world!".to_vec();
...
#[test]
fn test_dilithium2_signature_message() {
...
#[test]
fn test_dilithium2_detached_signature() {
    let (public_key, secret_key) = Dilithium2::keypair();
    let data = b"Hello, world!".to_vec();
...
#[test]
fn test_dilithium3_signature_message() {
...
#[test]
fn test_dilithium3_detached_signature() {
    let (public_key, secret_key) = Dilithium3::keypair();
    let data = b"Hello, world!".to_vec();
...
#[test]
fn test_dilithium5_signature_message() {
...
#[test]
fn test_dilithium5_detached_signature() {
    let (public_key, secret_key) = Dilithium5::keypair();
    let data = b"Hello, world!".to_vec();
